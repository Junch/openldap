...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./../../include" /I "./../libldap" $(INCLUDESSLPATH) $(INCLUDESASLPATH) /D "_CRT_SECURE_NO_WARNINGS" /D "NDEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "LDAP_LIBRARY" /D "LDAP_R_COMPILE" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\ldap_r" /FD /c 
RSC=rc.exe
LIB32=link.exe -lib
