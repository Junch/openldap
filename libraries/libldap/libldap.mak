...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./../../include" $(INCLUDESSLPATH) $(INCLUDESASLPATH) /D "_CRT_SECURE_NO_WARNINGS" /D "NDEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "LDAP_LIBRARY" /D "LDAP_LIBS_DYNAMIC" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\libldap_src" /FD /c 
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\libldap.res" /I "./../../include" /d "NDEBUG"
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib advapi32.lib ws2_32.lib liblber.lib $(LIBSSLPATH) $(LIBSASLPATH) /LIBPATH:"../liblber/$(OUTDIR)" /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\libldap.pdb" /debug /out:"$(OUTDIR)\libldap.dll" /def:"$(DEF_FILE)" /implib:"$(OUTDIR)\libldap.lib" /MACHINE:X86 /opt:ref 
LINK32_OBJS= \
	"$(INTDIR)\bind.obj" \
	"$(INTDIR)\open.obj" \
	"$(INTDIR)\result.obj" \
